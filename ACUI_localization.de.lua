...
-- MYADDONS
MYINVENTORY_MYADDON_NAME = "ACUI_MyInventory";
MYINVENTORY_MYADDON_DESCRIPTION = "Vereinfachtes, kompakteres Inventar.";
--KEYBINDINGS
BINDING_HEADER_MYINVENTORYHEADER= "ACUI_MyInventory";
BINDING_HEADER_MYINVENTORYCONFIGHEADER= "ACUI_MyInventory Config";
BINDING_NAME_MYINVENTORYICON= "ACUI_MyInventory Toggle";
BINDING_NAME_MYINVENTORYCONFIG   = "ACUI_MyInventory Konfigurationsfenster";
-- USAGE
MYINVENTORY_CHAT_COMMAND_USAGE= {
[1] = "Usage: /mi [Befehl]",
[2] = "Befehle:",
[3] = "show - ACUI_MyInventory Fenster zeigen/verstecken",
...
--MESSAGES
MYINVENTORY_MSG_LOADED = "Svartens/Rambles ACUI_MyInventory AddOn geladen.";
MYINVENTORY_MSG_INIT_s   = "ACUI_MyInventory: Profil fuer %s initialisiert.";
MYINVENTORY_MSG_CREATE_s = "ACUI_MyInventory: Erstelle neues Profil fuer %s";
--OPTION TOGGLE MESSAGES
MYINVENTORY_CHAT_PREFIX            = "ACUI_MyInventory: ";
...
MYINVENTORY_CHECKTIP_REPLACEBAGS     = "ACUI_MyInventory ersetzt die Standard-Taschen wenn aktiviert.";
