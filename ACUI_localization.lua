...
-- Translation : 
--   DE: Iruwen
MYINVENTORY_MYADDON_VERSION = "3.1.0.1 (30100)";
-- MYADDONS
...
BINDING_HEADER_MYINVENTORYCONFIGHEADER	= "My Inventory Config";
...
MYINVENTORY_CHAT_COMMAND_USAGE		= {
	...
	[2] = "Commands:",
	[3] = "show    - toggles the ACUI_MyInventory window",
...
--MESSAGES
MYINVENTORY_MSG_LOADED = "ACUI MyInventory AddOn loaded.";
MYINVENTORY_MSG_INIT_s   = "ACUI MyInventory: Profile for %s initialized.";
MYINVENTORY_MSG_CREATE_s = "ACUI MyInventory: Creating new Profile for %s";
...
--ACUI_MyInventory Options frame
...
MYINVENTORY_CHECKTIP_REPLACEBAGS     = "When checked, ACUI MyInventory takes over as the default bag";
...
MYINVENTORY_CHECKTIP_HIGHLIGHTBAGS   = "When you mouse over an item in ACUI MyInventory it will highlight the bag that that item is in.";
MYINVENTORY_CHECKTIP_HIGHLIGHTITEMS  = "When you mouse over a bag in ACUI MyInventory it will highlight all the items that are in that bag";
